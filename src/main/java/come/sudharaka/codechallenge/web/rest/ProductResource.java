...
/**
 * REST controller for managing {@link come.sudharaka.codechallenge.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getMethodology() != null) {
                    existingProduct.setMethodology(product.getMethodology());
                }
    ...
    public ResponseEntity<List<Product>> getAllProducts(
        ...
        if (filterByScrumMasterId != null) {
            page = productRepository.findByScrumMasterId(Long.parseLong(filterByScrumMasterId));
        } else if (filterByDeveloperId != null) {
            page = productRepository.findByDeveloperId(Long.parseLong(filterByDeveloperId));
        } else if (eagerload) {
