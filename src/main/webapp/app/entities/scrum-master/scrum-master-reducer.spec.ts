...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCRUMMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCRUMMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCRUMMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCRUMMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCRUMMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCRUMMASTER actions', async () => {
      const expectedActions = [
        {
