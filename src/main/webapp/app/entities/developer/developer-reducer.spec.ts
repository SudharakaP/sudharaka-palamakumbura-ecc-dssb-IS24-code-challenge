...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './developer.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { defaultValue, IDeveloper } from 'app/shared/model/developer.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVELOPER_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVELOPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVELOPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVELOPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVELOPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVELOPER actions', async () => {
      const expectedActions = [
        {
