...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOWNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOWNER actions', async () => {
      const expectedActions = [
        {
