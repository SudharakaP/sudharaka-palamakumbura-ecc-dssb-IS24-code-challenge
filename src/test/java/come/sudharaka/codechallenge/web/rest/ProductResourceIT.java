...
import come.sudharaka.codechallenge.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final Methodology DEFAULT_METHODOLOGY = Methodology.WATERFALL;
    private static final Methodology UPDATED_METHODOLOGY = Methodology.AGILE;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMethodology()).isEqualTo(DEFAULT_METHODOLOGY);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].methodology").value(hasItem(DEFAULT_METHODOLOGY.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.methodology").value(DEFAULT_METHODOLOGY.toString()))
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getMethodology()).isEqualTo(UPDATED_METHODOLOGY);
