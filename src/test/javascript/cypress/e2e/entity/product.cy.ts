...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="productName"]`).type('XSS').should('have.value', 'XSS');

      cy.get(`[data-cy="startDate"]`).type('2023-10-09').blur().should('have.value', '2023-10-09');

      cy.get(`[data-cy="methodology"]`).select('AGILE');

      cy.get(`[data-cy="location"]`).type('Balboa Sausages').should('have.value', 'Balboa Sausages');
